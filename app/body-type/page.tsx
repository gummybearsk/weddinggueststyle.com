...
export default function BodyTypePillarPage() {
  return (
    <PillarHub
      ...
      products={picksForPillar(getPillarSlugs("body-type"), 12)}
      groups={getPillarGroups("body-type")}
    />
  );
}
