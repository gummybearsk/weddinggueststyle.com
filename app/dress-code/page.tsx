...
const longForm = [
  ...
  "Cocktail attire is one of the dress codes guests meet most often on American wedding invitations. It calls for cocktail-length dresses (knee to mid-calf, or short maxi if very dressy), in fabrics one step up from everyday — chiffon, silk-blend, satin, lace, beaded, or polished crepe. Knee-length is the safest choice. Avoid: anything resembling a daytime sundress; jeans, ever; sequined mini-dresses that read more nightclub than wedding. The cocktail dress code spans the widest range of venues — restaurants, garden ceremonies, mid-formal hotels, and many destination weddings.",
