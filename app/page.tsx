      ...
      <section className="pt-4 pb-12 sm:pt-6 sm:pb-16 bg-ivory">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6 text-base leading-[1.8] text-ink-700 font-light">
            ...
            <p>
              Wedding Guest Style does not accept paid placements, sponsored reviews, free-product partnerships, or pay-to-feature deals. Products are matched to each page by searching Amazon for its topic, and their prices and stock are re-checked against Amazon&apos;s API every day; we have not worn or tested them. When you click an Amazon affiliate link and complete a purchase, we earn a small commission — at no cost to you. That commission funds the site. Commission rates play no part in which products appear. The full process is on the <Link href="/editorial" className="text-blush-600 hover:underline">editorial guidelines</Link> page.
            </p>
            <p>
